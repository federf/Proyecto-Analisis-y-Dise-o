...
public class Inmo {
    public static void main( String[] args ){
		...
		Building.createIt("type", "Departament","street", "Caseros 269", "neighborhood", "centro", "city", "Rio Cuarto","description", "Departamento de 3 ambientes en zona centrica con balcon, todos los servicios, amoblado","price", 500000,"status", "Sell");
